...
// @access  Admin/Teacher (later we can secure with middleware)
const createStudent = async (req, res) => {
  try {
    const { userId, rollNumber, className, section, contactNumber, feeDueDate } = req.body;

    if (!userId || !rollNumber || !className || !section) {
